...
int main() {
	...
	tester(quickSortS, n, randArray, "QuickSort");
	tester(mergeSort, n, randArray, "MergeSort");
	tester(mergeSortA, n, randArray, "MergeSort Advanced");
	tester(heapSort, n, randArray, "HeapSort");
	tester(heapSortA, n, randArray, "HeapSort Advanced");
